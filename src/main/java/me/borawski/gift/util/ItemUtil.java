...
public class ItemUtil {
        ...
        if (item != null) {
            ...
            if (item.getType().equals(Material.MOB_SPAWNER)) {
                ...
                try {
                    ...
                    System.out.println("[Gifts] could not parse entity id from " + entity.toUpperCase());
                }
            }
    ...
    public static ItemStack stringToItem(String item) {
        ...
        // Item is a mob spawner. //
        for (String word : itemWordList) {
            if (word.contains("entity:")) {
                ItemStack itemz = SilkUtil.hookIntoSilkSpanwers().newSpawnerItem(id, name, amount, false);
                return itemz;
